...
function AddLeave() {
  ...
  return (
    ...
    //     <h2 className="text-2xl font-bold mb-6">Reuest for Leave</h2>
    //     <form  onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">

    //       <div className='flex flex-col space-y-4 col-span-2'>
    //         <label className="block mb-1">Leave Type</label>
    //         <select name="leaveType" onChange={handleChange}
    //           className=" border p-2 mt-1 block border-gray-300 rounded-md">
    ...
    //           className=" border p-2 mt-1 block border-gray-300 rounded-md"required />
    //       </div>
    ...
    //           className="w-full border- border-gray-300"required></textarea>
    //       </div>

        
          

    //        <button type='submit' className='w-210 mx-auto mt-6 bg-teal-600 hover:bg-teal-700 text-white font-bold  py-2 px-4 cursor-pointer transition-all active:scale-95 duration-100'>Add Leave</button>
    //     </form>
    //   </div>
    //   </div>
